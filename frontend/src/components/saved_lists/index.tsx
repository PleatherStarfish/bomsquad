...
const SavedLists: React.FC = () => {
  ...
  const [addToShoppingListModalOpen, setAddToShoppingListModalOpen] =
  ...
  return (
    <>
          ...
          sortedArchivedShoppingLists.map((value, index) => (
            <div className="flex flex-col justify-center mt-4 mb-8" key={index}>
              <div className="flex justify-between py-4">
                <div className="flex flex-col justify-between gap-2">
                  <h2 className="text-xl font-bold text-gray-700">
                    {value.notes ||
                      (value.time_saved
                        ? new Date(value.time_saved).toLocaleString("en-US", {
                            day: "numeric",
                            hour: "2-digit",
                            minute: "2-digit",
                            month: "long",
                ...
                <div className="flex justify-between gap-3">
                  ...
                  <Button
                    onClick={() =>
                      handleAddArchivedList(value.time_saved, value.notes)
                    }
                    variant="primary"
                  >
              ...
              <div className="flex justify-center w-full p-8 rounded-md flex-nowrap bg-gray-50">
                {[{ data: [], name: "" }, ...value.groupedByModule].map(
                  (item, index) => {
                    ...
                    const moduleData =
                      item.data &&
                      Object.values(item.data as Record<string, any>)?.[0]?.[0]
                        ?.module
                        ? Object.values(item.data as Record<string, any>)[0][0]
                            .module
                        : {};
      ...
      <Modal
        onSubmit={() =>
          deleteArchivedShoppingList.mutate({ timestamp: selectedTimestamp! })
        }
      ...
      <Modal
        onSubmit={() =>
          addArchivedListToShoppingList({ timestamp: selectedTimestamp! })
        }
