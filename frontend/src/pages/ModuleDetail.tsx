...
const ModuleDetail: React.FC = () => {
  ...
  // @ts-expect-error: .hex() doesn't seem to be in the chroma type definition for some reason
  ...
  return (
    <>
        ...
        <div>
          <div className="mt-12">
            <div>
              ...
              <a className="text-gray-500 hover:text-gray-300" href={manufacturerDetailUrl}>
      ...
      <BomList bomUnderConstruction={!!module.bom_under_construction} moduleId={module.id} moduleName={module.name} />
    </>
  );
};
